...
mixin _$FoodState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Failure failure, List<Food> foods) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Failure failure, List<Food> foods)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>({
...
abstract class _$$_ErrorCopyWith<$Res> implements $FoodStateCopyWith<$Res> {
  ...
  @override
  @useResult
  $Res call({Failure failure, List<Food> foods});
}
...
class _$_Error implements _Error {
  const _$_Error({required this.failure, final List<Food> foods = const []})
      : _foods = foods;
  ...
  @override
  String toString() {
    return 'FoodState.error(failure: $failure, foods: $foods)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, failure, const DeepCollectionEquality().hash(_foods));
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(failure, foods);
  }
...
abstract class _Error implements FoodState {
  const factory _Error(
      {required final Failure failure, final List<Food> foods}) = _$_Error;
