...
import 'package:functional_variant/src/util/food_failure_x.dart';
import 'package:functional_variant/src/util/logger.dart';

import 'src/domain/bloc/food_bloc/food_bloc.dart';
import 'src/domain/entity/food.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Functional'),
    );
  }
}
